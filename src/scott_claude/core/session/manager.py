...
from scott_claude.core.bus.events import (
    SessionClosedEvent,
    SessionCreatedEvent,
...
from scott_claude.core.session.model import Session, SessionMode
...
class SessionManager:
    ...
    async def compact(self, sid: str, focus: str = "") -> Any:
        ...
        async with lock:
            from scott_claude.core.bus.commands import SessionCompactResult
