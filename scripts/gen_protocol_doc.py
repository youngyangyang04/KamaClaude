#!/usr/bin/env python3
"""Generate WIRE_PROTOCOL.md from pydantic models in scott_claude.core.bus."""
    ...
    sections = [
        ...
        _model_section("LogLineEvent", LogLineEvent,
            {"type": "log.line", "run_id": run_id, "level": "INFO",
             "source": "scott_claude.core.loop", "message": "step 1 started", "ts": ts}),
        "\n## Session Events\n\n",
        ...
        _model_section("PresetChangedEvent", PresetChangedEvent,
            {"type": "preset.changed", "kind": "skill", "name": "author-preset",
             "action": "write", "tier": "L", "path": ".scott/skills/author-preset.md",
             "run_id": run_id, "ts": ts}),
        "\n## Error Codes\n\n",
        "| Code | Name | Meaning |\n",
        "|------|------|---------|\n",
